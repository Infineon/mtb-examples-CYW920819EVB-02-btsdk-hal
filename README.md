...
This application group demonstrates HAL. Applications included are:

- low_power:
    - App demonstrates low power modes.
- gpio:
    - App demonstrates use of WICED GPIO apis to configure GPIOs as input/output.
- puart:
    - App demonstrates how to use PUART API's to read data over WICED Peripheral UART.
- pwm:
    - App demonstrates how to configure and use PWM in WICED Eval boards.
- adc:
    - App demonstrates how to configure and use ADC to measure DC voltage on DC input channels.
- uart_raw_mode:
    - App demonstrates how to use the HCI UART in Raw Data Mode.
